/// Algae information widget displaying detailed species data
        ...
        child: Column(
          ...
          children: [
            ...
            if (displayData['scientificWarning'] != null &&
              ...
              _buildWarningItem(
                Icons.science,
                AppStrings.scientificWarningShort,
                displayData['scientificWarning'],
                Colors.orange,
              ),
            ...
            _buildLeafVeinItem(
              ...
              AppStrings.toxicityStatus,
              displayData['toxicityWarning'] ?? AppStrings.underAnalysis,
              toxicityColor,
            ),
            const SizedBox(height: 16),
            if (displayData['potentialToxins'] != null &&
              ...
              _buildMultiLineLeafVeinItem(
                Icons.biotech,
                AppStrings.potentialToxinsTitle,
            ...
            if (displayData['sellable'] != null && displayData['sellable'] != '')
              _buildLeafVeinItem(
                Icons.shopping_cart,
                AppStrings.commercialViability,
